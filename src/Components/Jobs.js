...
const JobDetails = styled.div`
  ...
  @media (min-width: 768px) {
    padding: 1rem; // Increase padding for medium and larger screens
  }
`;
...
const CompanyName = styled.h3`
  ...
  color: #FE9900;
  font-weight: 600;
  font-size: 0.6rem; // Reduce font size for small screens
  
  @media (min-width: 768px) {
    font-size: 1.2rem; // Increase font size for medium and larger screens
  }
`;

const JobDescription = styled.p`
  margin-bottom: 0.2rem;
  font-size: 0.5rem; // Reduce font size for small screens
